        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-xl-8">
            <div className="title-area mb-35">
              <h2 className="sec-title">MEP Design</h2>
              <p className="sec-text mt-30">
                Capital Engineering Consultancy LLC is a distinguished leader in the UAE’s multi-disciplinary engineering sector, offering a comprehensive suite of MEP design services. Our expertise includes HVAC, electrical, plumbing, fire protection, and security and information technology systems. With an illustrious history of delivering exceptional outcomes, we are dedicated to providing unparalleled service excellence to our esteemed clients.
              </p>
              <p className="sec-text mt-30">
                Our MEP design services encompass a broad spectrum of solutions, ranging from meticulous analysis and conceptualization to precise construction budgeting, detailed services documentation, and comprehensive construction administration. Collaborating closely with our clients, we craft bespoke solutions tailored to their specific needs, consistently striving to exceed expectations at every phase of the project lifecycle.
              </p>
              <p className="sec-text mt-30">
          ...
          <div className="col-xl-8">
            <p className="sec-text mb-30">
              What sets us apart is our unwavering commitment to quality, meticulous attention to detail, and dedication to delivering exceptional customer service. Whether you seek a comprehensive MEP design partner or require specialized support, we possess the expertise and experience to fulfill your requirements with excellence.
            </p>
            ...
            <p className="sec-text mb-40 mt-30">
              Choose Capital Engineering Consultancy LLC as your trusted partner for all your MEP design needs, and elevate your projects to new heights of engineering excellence.
            </p>
